...
node --test --experimental-strip-types tests/refs.test.ts tests/lexical.test.ts tests/anchors.test.ts tests/structural.test.ts tests/verdict.test.ts > /dev/null 2>&1 \
  && echo "── unit suites OK ──"
