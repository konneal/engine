...
- citation questions ("what does X cite/reference/list?", "which standards does X reference?"): ALWAYS include a query variant that names the document's bibliography or normative-references section explicitly (e.g. for "What ISO standards does R 60 cite?" generate the variant "R 60 bibliography normative references ISO IEC") \u2014 the bibliography clause embeds differently than the query's phrasing and needs its own retrieval.
